...
import firebase, { auth } from '../firebase.mjs';
          ...
          <nav className="navbar ms-navbar">
            ...
            <ul className="ms-nav-list ms-inline mb-0" id="ms-nav-options">
              ...
              <li className="ms-nav-item">
                <Link to="/patient_register" className="btn btn-primary mt-0">Register</Link>
              </li>
              <li className="ms-nav-item">
              ...
              <div className="ms-auth-col">
                <div className="ms-auth-form">
                  <form noValidate="" onSubmit={handleSignin}>
                    ...
                    <button type="button" className="btn mt-4 d-block w-100 btn-social-login"> <img src={"../assets/img/others/facebook.png"} alt="image" /> <span>Login with Facebook</span> </button>
                    ...
                    <p className="mb-0 mt-3 text-center">Don't have an account?  <Link className="btn-link" to="/patient_register">Create Account</Link> </p>
                  </form>
                </div>
              </div>
            </div>
