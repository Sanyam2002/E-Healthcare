                            ...
                            <div className="ms-auth-col">
                                <div className="ms-auth-form">
                                    <form onSubmit={handleSignin}>
                                        ...
                                        <p className="mb-0 mt-3 text-center">Don't have an account?  <Link className="btn-link" to="/lab_regsiter">Create Account</Link> </p>
                                    </form>
                                </div>
                            </div>
                        </div>
...
export default LabTester_login