            ...
            <div class="row">
              <div class="col-xl-12">
                <div class="bradcam_text">
                  <h3>Dental Care</h3>
                  <p><a href="/">Home /</a>Dental Care</p>
                  <p>
                  Dentists are trained professionals who help care for the teeth
                  <br/> and mouth. Regularly seeing a dentist can help you to 
                  <br/> a good level of dental health, which may have a direct 
                  <br/>impact on your overall well-being.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-xl-12">
                ...
                <div class="row owl-stage" >
                    {doctors.map((doctor) => {
                      if (doctor.medicalSpeciality === "Dental")
                        return (
                  ...
                  </div></div><div class="owl-nav"><div class="owl-prev"><i class="ti-angle-left"></i></div><div class="owl-next"><i class="ti-angle-right"></i></div></div><div class="owl-dots disabled"></div></div>
              </div>
            </div>
          </div>
        </div>
