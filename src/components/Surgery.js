            ...
            <div class="row">
              <div class="col-xl-12">
                <div class="bradcam_text">
                  <h3>Surgery</h3>
                  <p><a href="/">Home /</a> Surgery Service</p>
                  <p>A surgeon is a doctor who specializes in evaluating and treating
                    <br/> conditions that may require surgery, or physically changing 
                    <br/>the human body. Surgeries can be done to diagnose or treat disease or injury.</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="col-xl-12">
                <div class="expert_active owl-carousel owl-loaded owl-drag"><div class="owl-stage-outer">
                  <div class="row owl-stage" >
                    {doctors.map((doctor) => {
                      if (doctor.medicalSpeciality === "Surgery")
                        return (
