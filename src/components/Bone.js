            ...
            <div class="row">
              <div class="col-xl-12">
                <div class="bradcam_text">
                  <h3>Bone Specialist</h3>
                  <p><a href="/">Home /</a> Bone Care</p>
                  <p>
                  Orthopedic surgeons are doctors who specialize in the musculoskeletal system 
                  <br/>- the bones, joints, ligaments, tendons, and muscles that are so essential
                  <br/> to movement and everyday life.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-xl-12">
                ...
                <div class="row owl-stage" >
                    {doctors.map((doctor) => {
                      if (doctor.medicalSpeciality === "Orthopedic")
                        return (
