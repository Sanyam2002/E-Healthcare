               ...
               <ul id="pages" className="collapse" aria-labelledby="pages" data-parent="#side-nav-accordion">
                  <li className="menu-item">
                     ...
                     <ul id="authentication" className="collapse" aria-labelledby="authentication" data-parent="#pages">
                        <li> <Link to="default-login.html">Default Login</Link> </li>
                        <li> <Link to="modal-login.html">Modal Login</Link> </li>
                        <li> <Link to="default-register.html">Default Registration</Link> </li>
                        <li> <Link to="modal-register.html">Modal Registration</Link> </li>
                  ...
                  <li className="menu-item"> <Link to="faq.html"> FAQ </Link> </li>
                  <li className="menu-item"> <Link to="portfolio.html"> Portfolio </Link> </li>
                  <li className="menu-item"> <Link to="user-profile.html"> User Profile </Link> </li>
                  <li className="menu-item"> <Link to="invoice.html"> Invoice </Link> </li>
               </ul>
            </li>
               ...
               <div className="ms-auth-col">
                  <div className="ms-auth-form">
                     <form className="needs-validation" novalidate="">
                        ...
                        <button type="button" className="btn mt-4 d-block w-100 btn-social-login"> <img src={"../assets/img/others/facebook.png"} alt="image"/> <span>Signup with Facebook</span> </button>
                        <button type="button" className="btn mt-4 d-block w-100 btn-social-login"> <img src={"../../assets/img/others/google.png"} alt="image"/> <span>Signup with Google</span> </button>
                        <p className="mb-0 mt-3 text-center">Already have an account? <Link className="btn-link" to="default-login.html">Login</Link> </p>
                     </form>
                  </div>
               </div>
            </div>
