            ...
            <div class="row">
              <div class="col-xl-12">
                <div class="bradcam_text">
                  <h3>Physician</h3>
                  <p><a href="/">Home /</a> Physician</p>
                  <p>A physician is a medical doctor who usually focuses on the non-surgical
                    <br />
                    treatment of patients' conditions. That is not to say that being a physician is
                    <br /> not practical; most specialisms have a unique range of procedures that relate to their specialty.</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="col-xl-12">
                <div class="expert_active owl-carousel owl-loaded owl-drag"><div class="owl-stage-outer">
                  <div class="row owl-stage" >
                    {doctors.map((doctor) => {
                      if (doctor.medicalSpeciality === "General")
                        return (
