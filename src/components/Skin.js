            ...
            <div class="row">
              <div class="col-xl-12">
                <div class="bradcam_text">
                  <h3>Skin Care</h3>
                  <p><a href="/">Home /</a> Skin</p>
                  <p>A dermatologist is a medical doctor who specializes in conditions<br/> that affect the skin, hair, and nails.</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="col-xl-12">
                <div class="expert_active owl-carousel owl-loaded owl-drag"><div class="owl-stage-outer">
                    ...
                    <div class="row owl-stage" >
                      {doctors.map((doctor) => {
                        if (doctor.medicalSpeciality === "Skin")
                          return (
